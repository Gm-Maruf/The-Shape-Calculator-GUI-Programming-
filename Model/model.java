...
public class model extends Observable {
    ...
    public void computeString() {
        ...
        Calculations possibleOperations = new Calculations();
    ...
    private LinkedList<String> performMathInSequence(LinkedList<String> operationTokens, /*Calculations*/ possibleOperations) {
    ...
    public void Clear() {
        ...
        DisplayData update = new DisplayData();
